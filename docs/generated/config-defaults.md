...
| `voice_rtc_url` | `String` | `default_voice_rtc_url` | `"ws://localhost:8080".into()` |
| `voice_rtc_health_url` | `String` | `default_voice_rtc_health_url` | `"http://localhost:8081".into()` |
| `image_provider` | `String` | `serde(default)` | `""` |
| `image_api_key` | `String` | `serde(default)` | `""` |
| `image_api_url` | `String` | `serde(default)` | `""` |
| `image_model` | `String` | `serde(default)` | `""` |
| `image_default_size` | `String` | `default_image_size` | `"1024x1024".into()` |
